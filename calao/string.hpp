...
#ifndef CALAO_STRING_HPP
#define CALAO_STRING_HPP
...
#include <calao/utils/ref_count.hpp>
...
//inline
//std::ostream &operator<<(std::ostream &out, const calao::String &s)
//{
...
template<>
struct hash<calao::String>
{
	size_t operator()(const calao::String &s) const noexcept
	{
		return s.hash();
	}
};
