 ...
 *                                                                                                                    *
 * Note: If the macro CALAO_STD_UNORDERED_MAP is defined, Hashmap will simply be an alias for std::unordered_map.     *
 *                                                                                                                    *
 **********************************************************************************************************************/

#ifndef CALAO_HASHMAP_HPP
#define CALAO_HASHMAP_HPP
...
#endif // CALAO_STD_UNORDERED_MAP
#endif // CALAO_HASHMAP_HPP
